An iTerm theme based on a colour scheme called Monokai Soda provided with the [Monokai Soda](https://github.com/buymeasoda/soda-theme/) theme for [Sublime Text](http://www.sublimetext.com/).
